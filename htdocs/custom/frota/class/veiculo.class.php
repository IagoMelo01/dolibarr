...
class Veiculo extends CommonObject
{
	...
	public $fields=array(
		...
		"fk_project" => array("type"=>"integer:Project:projet/class/project.class.php:1:fk_statut=1", "label"=>"Fkproject", "picto"=>"project", "enabled"=>"1", 'position'=>35, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1", "css"=>"maxwidth500 widthcentpercentminusxx", "csslist"=>"tdoverflowmax150",),
		...
		"fabricante" => array("type"=>"integer", "label"=>"Fabricante", "enabled"=>"1", 'position'=>95, 'notnull'=>1, "visible"=>"-1", "alwayseditable"=>"1",),
		"modelo" => array("type"=>"varchar(255)", "label"=>"Modelo", "enabled"=>"1", 'position'=>100, 'notnull'=>1, "visible"=>"-1", "alwayseditable"=>"1",),
		"ano_fab" => array("type"=>"varchar(10)", "label"=>"Anofab", "enabled"=>"1", 'position'=>105, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"num_identificacao" => array("type"=>"varchar(10)", "label"=>"Numidentificacao", "enabled"=>"1", 'position'=>110, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"cap_carga" => array("type"=>"integer", "label"=>"Capcarga", "enabled"=>"1", 'position'=>115, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"km" => array("type"=>"double(12,2)", "label"=>"Km", "enabled"=>"1", 'position'=>120, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"horas_op" => array("type"=>"double(12,2)", "label"=>"Horasop", "enabled"=>"1", 'position'=>125, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"documento" => array("type"=>"varchar(255)", "label"=>"Documento", "enabled"=>"1", 'position'=>130, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"potencia" => array("type"=>"integer", "label"=>"Potencia", "enabled"=>"1", 'position'=>135, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
	);
	public $rowid;
	public $ref;
	public $label;
