...
class Implemento extends CommonObject
{
	...
	public $fields=array(
		...
		"marca" => array("type"=>"varchar(255)", "label"=>"Marca", "enabled"=>"1", 'position'=>95, 'notnull'=>1, "visible"=>"-1", "alwayseditable"=>"1",),
		"tipo" => array("type"=>"varchar(255)", "label"=>"Tipo", "enabled"=>"1", 'position'=>100, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"ano_fab" => array("type"=>"varchar(10)", "label"=>"Anofab", "enabled"=>"1", 'position'=>105, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"num_identificacao" => array("type"=>"varchar(32)", "label"=>"Numidentificacao", "enabled"=>"1", 'position'=>110, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"capacidade" => array("type"=>"double(12,2)", "label"=>"Capacidade", "enabled"=>"1", 'position'=>115, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"largura_trab" => array("type"=>"double(12,2)", "label"=>"Larguratrab", "enabled"=>"1", 'position'=>120, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"ultima_manutencao" => array("type"=>"date", "label"=>"Ultimamanutencao", "enabled"=>"1", 'position'=>125, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
		"documento" => array("type"=>"varchar(128)", "label"=>"Documento", "enabled"=>"1", 'position'=>130, 'notnull'=>0, "visible"=>"-1", "alwayseditable"=>"1",),
	);
	public $rowid;
	public $ref;
	public $label;
