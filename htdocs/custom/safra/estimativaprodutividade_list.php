...
/**
 *   	\file       estimativaprodutividade_list.php
 *		\ingroup    safra
 *		\brief      List page for estimativaprodutividade
 */
...
require_once __DIR__.'/class/estimativaprodutividade.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('safra', 'estimativaprodutividade', 'write');
	$permissiontodelete = $user->hasRight('safra', 'estimativaprodutividade', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'EstimativaProdutividade';
	$objectlabel = 'EstimativaProdutividade';
...
$title = $langs->trans("EstimativaProdutividades");
//$help_url = "EN:Module_EstimativaProdutividade|FR:Module_EstimativaProdutividade_FR|ES:Módulo_EstimativaProdutividade";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/safra/estimativaprodutividade_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/safra/estimativaprodutividade_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendEstimativaProdutividadeRef";
$modelmail = "estimativaprodutividade";
$objecttmp = new EstimativaProdutividade($db);
