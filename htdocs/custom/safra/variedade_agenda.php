...
/**
 *  \file       variedade_agenda.php
 *  \ingroup    safra
 *  \brief      Tab of events on Variedade
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Variedade")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Variedade"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_variedade_'.$object->id;
