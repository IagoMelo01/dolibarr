...
class modSafra extends DolibarrModules
{
	...
	{
		global $langs, $conf;
		$this->db = $db;		// Id for module (must be unique).
		// Use here a free id (See in Home -> System information -> Dolibarr for list of used modules id).
		$this->numero = 500010; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'safra';		// Family can be 'base' (core modules),'crm','financial','hr','projects','products','ecm','technic' (transverse modules),'interface' (link with external tools),'other','...'
		// It is used to group modules by family in module setup page
		$this->family = "other";		// Module position in the family on 2 digits ('01', '10', '20', ...)
		$this->module_position = '90';		// Gives the possibility for the module, to provide his own family info and position of this family (Overwrite $this->family and $this->module_position. Avoid this)
		...
		$this->name = preg_replace('/^mod/i', '', get_class($this));		// Module description, used if translation string 'ModuleSafraDesc' not found (Safra is name of module).
		$this->description = "SafraDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "SafraDescription";		// Author
		$this->editor_name = 'Farmevo';
		$this->editor_url = 'farmevo.com.br';		// Possible values for version are: 'development', 'experimental', 'dolibarr', 'dolibarr_deprecated', 'experimental_deprecated' or a version string like 'x.y.z'
		$this->version = '1.0';
		// Url to the file with your last numberversion of this module
		//$this->url_last_version = 'http://www.example.com/versionmodule.txt';		// Key used in llx_const table to save module status enabled/disabled (where SAFRA is value of property name of module in uppercase)
		$this->const_name = 'MAIN_MODULE_'.strtoupper($this->name);		// Name of image file used for this module.
		// If file is in theme/yourtheme/img directory under name object_pictovalue.png, use this->picto='pictovalue'
		// If file is in module/img directory under name object_pictovalue.png, use this->picto='pictovalue@module'
		// To use a supported fa-xxx css style of font awesome, use this->picto='xxx'
		$this->picto = 'fa-seedling';		// Define some features supported by module (triggers, login, substitutions, menus, css, etc...)
		...
		$this->dirs = array("/safra/temp");		// Config pages. Put here list of php page, stored into safra/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@safra");		// Dependencies
		...
		$this->langfiles = array("safra@safra");		// Prerequisites
		...
		// );
		$this->const = array();		// Some keys to add into the overwriting translation tables
		...
		$this->dictionaries = array();
		/* END MODULEBUILDER DICTIONARIES */		// Boxes/Widgets
		...
		/* END MODULEBUILDER WIDGETS */		// Cronjobs (List of cron jobs entries to add when module is enabled)
		...
		$this->rights[$r][1] = 'Read EstimativaProdutividade object of Safra';
		$this->rights[$r][4] = 'estimativaprodutividade';
		$this->rights[$r][5] = 'read';
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf('%02d', (1 * 10) + 1 + 1);
		$this->rights[$r][1] = 'Create/Update EstimativaProdutividade object of Safra';
		$this->rights[$r][4] = 'estimativaprodutividade';
		...
		$this->rights[$r][1] = 'Read Variedade object of Safra';
		$this->rights[$r][4] = 'variedade';
		$this->rights[$r][5] = 'read';
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf('%02d', (5 * 10) + 1 + 1);
		$this->rights[$r][1] = 'Create/Update Variedade object of Safra';
		$this->rights[$r][4] = 'variedade';
		$this->rights[$r][5] = 'write';
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf('%02d', (5 * 10) + 2 + 1);
		$this->rights[$r][1] = 'Delete Variedade object of Safra';
		$this->rights[$r][4] = 'variedade';
		$this->rights[$r][5] = 'delete';
		$r++;
		...
		$this->menu[$r++]=array(
			 ...
			 'mainmenu' => 'safra',
			 'leftmenu' => 'variedade',
			 'url' => '/safra/variedade_list.php',
			 'langs' => 'safra@safra',
			 'position' => 1000 + $r,
			 'enabled' => 'isModEnabled(\'safra\')',
			 'perms' => '$user->hasRight(\'safra\', \'variedade\', \'read\')',
			 'target' => '',
			 'user' => 2,
		);
		/* END LEFTMENU VARIEDADE */
		/* LEFTMENU LIST VARIEDADE */
		$this->menu[$r++]=array(
			 'fk_menu' => 'fk_mainmenu=safra,fk_leftmenu=variedade',
			 'type' => 'left',
			 'titre' => 'List Variedade',
			 'mainmenu' => 'safra',
			 'leftmenu' => 'safra_variedade_list',
			 'url' => '/safra/variedade_list.php',
			 'langs' => 'safra@safra',
			 'position' => 1000 + $r,
			 'enabled' => 'isModEnabled(\'safra\')',
		...
		/* END LEFTMENU LIST VARIEDADE */
		/* LEFTMENU NEW VARIEDADE */
		$this->menu[$r++]=array(
			 'fk_menu' => 'fk_mainmenu=safra,fk_leftmenu=variedade',
			 'type' => 'left',
			 'titre' => 'New Variedade',
			 'mainmenu' => 'safra',
			 'leftmenu' => 'safra_variedade_new',
			 'url' => '/safra/variedade_card.php?action=create',
			 'langs' => 'safra@safra',
			 'position' => 1000 + $r,
			 'enabled' => 'isModEnabled(\'safra\')',
			 'perms' => '$user->hasRight(\'safra\', \'variedade\', \'write\')',
			 'target' => '',
			 'user' => 2,
		);
		/* END LEFTMENU NEW VARIEDADE */
		/* LEFTMENU TALHAO */
		$this->menu[$r++]=array(
			 'fk_menu' => 'fk_mainmenu=safra',
			 'type' => 'left',
		...
		/* LEFTMENU ESTIMATIVAPRODUTIVIDADE */
		$this->menu[$r++]=array(
			 'fk_menu' => 'fk_mainmenu=safra',
			 'type' => 'left',
			 'titre' => 'EstimativaProdutividade',
			 'mainmenu' => 'safra',
			 'leftmenu' => 'estimativaprodutividade',
			 'url' => '/safra/estimativaprodutividade_list.php',
			 'langs' => 'safra@safra',
			 'position' => 1000 + $r,
			 'enabled' => 'isModEnabled(\'safra\')',
			 'perms' => '$user->hasRight(\'safra\', \'estimativaprodutividade\', \'read\')',
			 'target' => '',
			 'user' => 2,
		);
		/* END LEFTMENU ESTIMATIVAPRODUTIVIDADE */
		/* LEFTMENU LIST ESTIMATIVAPRODUTIVIDADE */
		$this->menu[$r++]=array(
			 'fk_menu' => 'fk_mainmenu=safra,fk_leftmenu=estimativaprodutividade',
			 'type' => 'left',
			 'titre' => 'List EstimativaProdutividade',
			 'mainmenu' => 'safra',
			 'leftmenu' => 'safra_estimativaprodutividade_list',
			 'url' => '/safra/estimativaprodutividade_list.php',
			 'langs' => 'safra@safra',
			 'position' => 1000 + $r,
			 'enabled' => 'isModEnabled(\'safra\')',
		...
		/* END LEFTMENU LIST ESTIMATIVAPRODUTIVIDADE */
		/* LEFTMENU NEW ESTIMATIVAPRODUTIVIDADE */
		$this->menu[$r++]=array(
			 'fk_menu' => 'fk_mainmenu=safra,fk_leftmenu=estimativaprodutividade',
			 'type' => 'left',
			 'titre' => 'New EstimativaProdutividade',
			 'mainmenu' => 'safra',
			 'leftmenu' => 'safra_estimativaprodutividade_new',
			 'url' => '/safra/estimativaprodutividade_card.php?action=create',
			 'langs' => 'safra@safra',
			 'position' => 1000 + $r,
			 'enabled' => 'isModEnabled(\'safra\')',
			 'perms' => '$user->hasRight(\'safra\', \'estimativaprodutividade\', \'write\')',
			 'target' => '',
			 'user' => 2,
		);
		/* END LEFTMENU NEW ESTIMATIVAPRODUTIVIDADE */
	...
	{
		global $conf, $langs;		//$result = $this->_load_tables('/install/mysql/', 'safra');
		...
		//$result5=$extrafields->addExtraField('safra_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'safra@safra', 'isModEnabled("safra")');		// Permissions
		$this->remove($options);		$sql = array();		// Document templates
		$moduledir = dol_sanitizeFileName('safra');
		$myTmpObjects = array();
		$myTmpObjects['Cultura'] = array('includerefgeneration'=>0, 'includedocgeneration'=>0);		foreach ($myTmpObjects as $myTmpObjectKey => $myTmpObjectArray) {
			...
			if ($myTmpObjectArray['includerefgeneration']) {
				...
				$dest = $dirodt.'/template_culturas.odt';				if (file_exists($src) && !file_exists($dest)) {
