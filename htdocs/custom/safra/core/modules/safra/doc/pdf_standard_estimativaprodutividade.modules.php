...
/**
 *  \file       core/modules/safra/doc/pdf_standard.modules.php
 *  \ingroup    safra
...
/**
 *	Class to manage PDF template standard_estimativaprodutividade
 */
class pdf_standard_estimativaprodutividade extends ModelePDFEstimativaProdutividade
{
	/**
	 ...
	 *
	 *  @param		EstimativaProdutividade	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  EstimativaProdutividade	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('SAFRA_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('SAFRA_DRAFT_WATERMARK')));
		}
